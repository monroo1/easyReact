              ...
              {relationshipFormat === "ТД" ? (
                <>
                  <div>
                    ...
                    <select className="input-form">
                      <option>
                        Заявление на увольнение прикрепить скан (поле);
                      </option>
                      <option>
                      ...
                      <option>
                        Сокращение доп. поле с указанием дружественное/не
                        дружественное;
                      </option>
                      <option>
                        Статья прикрепить сканы обосновывающих документов
                        (поле);
                      </option>
                    </select>
                  </div>
                ...
                <div>
                  ...
                  >
                    <img
                      ...
                      alt="Article"
                    />
                    Внутренний обходной лист, подписанный руководителем, скан
                    (поле)
                  </label>
                  <input type="file" id="reporting-previous-year" />
                  <label
